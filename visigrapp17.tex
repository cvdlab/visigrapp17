...
\email{\{marino, salvati, spini, vadala, paoluzzi\}@ing.uniroma3.it, \{mvicentino, abottaro\}@geoweb.it}
}

\newcommand{\acks}{Partially supported by grant from GEOWEB S.p.A., a company owned by Sogei S.p.A. and CNGeGL ---  the ICT company of the Italian Ministry of Economy and Finance and the Italian National Board of Quantity Surveyors, respectively.}
